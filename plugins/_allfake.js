		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: {
					...
					sourceUrl: 'https://saweria.co/branbot'			
				}
			}
		}
                global.flocation = {
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            { remoteJid: "120363232428425970@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
       ...
       key: {
                   fromMe: false,
                   participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6285795600265@s.whatsapp.net" } : {})
               },
               message: {
                   "productMessage": {
                       "product": {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "120363232428425970@g.us",
                   "inviteCode": "null",
                   "groupName": "Elaina By Bran", 
